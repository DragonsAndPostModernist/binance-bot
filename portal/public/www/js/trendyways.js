 ...
 * The purchase of the mean (the number of elements to sum) is based on the weight's length.
 ...
 * @param {array} closePrices list of closing prices
 * @param {value} order purchase of the momentum
 ...
 * @param {array} closePrices list of closing prices
 * @param {value} order purchase of the ROC
 ...
 * @param {array} closePrices list of closing prices
 * @param {value} order RSI purchase (typically 14)
